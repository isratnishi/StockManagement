...
public class GaryFebricScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gary_febric_scan);
        ...
        buttonScanRoll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                (new IntentIntegrator(GaryFebricScanActivity.this)).initiateScan();
            }
        });
    }
                ...
                registrationRequest.enqueue(new Callback<GrayRollDetailInfo>() {
                    ...
                    public void onResponse(Call<GrayRollDetailInfo> call, @NonNull Response<GrayRollDetailInfo> response) {
                        if (response.body() != null) {
                            ...
                            Toasty.error(GaryFebricScanActivity.this, "SESSION_EXPIRED", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(GaryFebricScanActivity.this, List2Activity.class);
